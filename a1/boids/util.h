...
extern int nBoids;				// Number of boids to dispay
...
extern float r_rule1;		   
extern float r_rule2;		  
extern float r_rule3;
extern float k_rule1;
extern float k_rule2;
extern float k_rule3;
extern float k_rule0;
